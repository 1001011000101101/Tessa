...
В мануалах присутствует демонстрация не самых лучших практик программирования, а именно, проблема с [типобезопасностью](https://en.wikipedia.org/wiki/Type_safety)
...
![Image of Yaktocat](https://github.com/1001011000101101/Tessa/blob/master/images/TypeSafety.png)
